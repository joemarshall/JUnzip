 ...
 * @param raw if this is non-zero, assume no header and just inflate
 *
 * @return number of bytes decompressed, or -1 in case of an error
 */
size_t em_inflate(const void *pCompressedData, size_t nCompressedDataSize, unsigned char *pOutData, size_t nMaxOutDataSize,int raw);
